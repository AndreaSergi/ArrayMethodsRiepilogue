...
const studentVote = studenti.find(student => student.voto > 90)
console.log (studentVote)

const voteSum = studenti.reduce((acc,cur) => acc + cur.voto,0) 
const voteAverage = voteSum / studenti.length;
console.log(voteAverage)


const capsNames = studenti.map(student => student.nome.toUpperCase())
console.log(capsNames)


const studentsNerd = studenti.filter(student => student.voto > 85)
console.log(studentsNerd)